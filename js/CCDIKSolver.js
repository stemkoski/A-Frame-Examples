		...
		for ( let i = 0; i < iteration; i ++ ) {
			...
			for ( let j = 0, jl = links.length; j < jl; j ++ ) {
				...
				if ( rotationMin !== undefined ) {
					...
					// setFromEuler is new; inserting code here...
					_vector.x = link.rotation._x;
					_vector.y = link.rotation._y;
					_vector.z = link.rotation._z;
					link.rotation.setFromVector3( _vector.max( rotationMin ) );
				...
				if ( rotationMax !== undefined ) {
					...
					_vector.y = link.rotation._y;
					_vector.z = link.rotation._z;
					link.rotation.setFromVector3( _vector.min( rotationMax ) );
